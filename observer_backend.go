...
// Init(...) -> state
func (o *observerBackend) Init(p *Process, args ...interface{}) (interface{}, error) {
...
func (o *observerBackend) HandleCall(from etf.Tuple, message etf.Term, state GenServerState) (string, etf.Term) {
