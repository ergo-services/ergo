...
func factory_iprocess() gen.ProcessBehavior {
	return &iprocess{}
}

type iprocess struct {
	act.Actor
	token gen.Ref
...
func (ip *iprocess) Init(args ...any) error {
...
func (ip *iprocess) HandleMessage(from gen.PID, message any) error {
...
func (ip *iprocess) Terminate(reason error) {
